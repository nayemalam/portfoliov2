  ...
  render() {
    return (
      <div className='header'>
        <h1 className='customHeader centerText' style={{fontSize: '45px', color: '#07bbf2'}}>Hi, I'm Nayem.</h1>
        <p className='customHeader centerText justifyText' style={{margin: '0 50px 0 50px', color: '#8cea95'}}>
